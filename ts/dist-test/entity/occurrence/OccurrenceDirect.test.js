...
(0, node_test_1.describe)('OccurrenceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-occurrence', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-occurrence', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GBIF_TEST_OCCURRENCE_ENTID'];
...
//# sourceMappingURL=OccurrenceDirect.test.js.map