...
(0, node_test_1.describe)('VocabularyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-vocabulary', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-vocabulary', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GBIF_TEST_VOCABULARY_ENTID'];
...
//# sourceMappingURL=VocabularyDirect.test.js.map