...
(0, node_test_1.describe)('RegistryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-registry', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-registry', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GBIF_TEST_REGISTRY_ENTID'];
...
//# sourceMappingURL=RegistryDirect.test.js.map