...
describe("OccurrenceDirect", function()
  it("should direct-list-occurrence", function()
    local setup = occurrence_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-occurrence", setup.live and "live" or "unit")
...
function occurrence_direct_setup(mockres)
