...
describe("LiteratureDirect", function()
  it("should direct-list-literature", function()
    local setup = literature_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-literature", setup.live and "live" or "unit")
...
function literature_direct_setup(mockres)
