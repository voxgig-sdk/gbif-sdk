...
describe("VocabularyDirect", function()
  it("should direct-list-vocabulary", function()
    local setup = vocabulary_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-vocabulary", setup.live and "live" or "unit")
...
function vocabulary_direct_setup(mockres)
