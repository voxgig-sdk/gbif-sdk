...
describe("RegistryDirect", function()
  it("should direct-list-registry", function()
    local setup = registry_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-registry", setup.live and "live" or "unit")
...
function registry_direct_setup(mockres)
