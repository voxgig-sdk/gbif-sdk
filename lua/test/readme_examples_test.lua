...
-- data to return.
local TEST_SEED = '{ entity = { ["enumeration"] = { ["test01"] = { id = "test01" } }, ["literature"] = { ["test01"] = { id = "test01" } }, ["occurrence"] = { ["test01"] = { id = "test01" } }, ["registry"] = { ["test01"] = { id = "test01" } }, ["species"] = { ["test01"] = { id = "test01" } }, ["vocabulary"] = { ["test01"] = { id = "test01" } } } }'
