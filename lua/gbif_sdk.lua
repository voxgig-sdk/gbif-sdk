...
GbifSDK._make_feature = _make_feature


function GbifSDK.new(options)
  local self = setmetatable({}, GbifSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GbifSDK:get_utility()
  return Utility.copy(self._utility)
end


function GbifSDK:get_root_ctx()
  return self._rootctx
end


function GbifSDK:prepare(fetchargs)
...
function GbifSDK:direct(fetchargs)
...
-- by passing it.
function GbifSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GbifSDK:graphql(query, variables, ctrl)
...
function GbifSDK:Enumeration(data)
  ...
  if data == nil then
    if self._enumeration == nil then
      self._enumeration = EntityMod.new(self, nil)
    end
...
function GbifSDK:Literature(data)
  ...
  if data == nil then
    if self._literature == nil then
      self._literature = EntityMod.new(self, nil)
    end
...
function GbifSDK:Occurrence(data)
  ...
  if data == nil then
    if self._occurrence == nil then
      self._occurrence = EntityMod.new(self, nil)
    end
...
function GbifSDK:Registry(data)
  ...
  if data == nil then
    if self._registry == nil then
      self._registry = EntityMod.new(self, nil)
    end
...
function GbifSDK:Vocabulary(data)
  ...
  if data == nil then
    if self._vocabulary == nil then
      self._vocabulary = EntityMod.new(self, nil)
    end
...
function GbifSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
