...
local LiteratureEntity = {}
LiteratureEntity.__index = LiteratureEntity


function LiteratureEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LiteratureEntity)
...
function LiteratureEntity:get_name()
  return self._name
end


function LiteratureEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LiteratureEntity.new(self._client, opts)
end
...
function LiteratureEntity:mark_deleted()
  self._deleted = true
end


function LiteratureEntity:deleted()
  return true == self._deleted
end


function LiteratureEntity:data_set(args)
  if args ~= nil then
...
function LiteratureEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LiteratureEntity:match_set(args)
  if args ~= nil then
...
function LiteratureEntity:match_get()
...
function LiteratureEntity:stream(action, args, callopts)
...
function LiteratureEntity:_run_op(ctx, post_done)
  local utility = self._utility
