...
local EnumerationEntity = {}
EnumerationEntity.__index = EnumerationEntity


function EnumerationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnumerationEntity)
  self._name = "enumeration"
  self._client = client
...
function EnumerationEntity:get_name()
  return self._name
end


function EnumerationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnumerationEntity.new(self._client, opts)
end
...
function EnumerationEntity:mark_deleted()
  self._deleted = true
end


function EnumerationEntity:deleted()
  return true == self._deleted
end


function EnumerationEntity:data_set(args)
  if args ~= nil then
...
function EnumerationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnumerationEntity:match_set(args)
  if args ~= nil then
...
function EnumerationEntity:match_get()
...
function EnumerationEntity:stream(action, args, callopts)
...
---@param reqmatch EnumerationLoadMatch
---@param ctrl? table
---@return Enumeration
---@return string? err
function EnumerationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch EnumerationListMatch
---@param ctrl? table
---@return Enumeration[]
---@return string? err
function EnumerationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function EnumerationEntity:_run_op(ctx, post_done)
  local utility = self._utility
