...
local VocabularyEntity = {}
VocabularyEntity.__index = VocabularyEntity


function VocabularyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VocabularyEntity)
  self._name = "vocabulary"
  self._client = client
...
function VocabularyEntity:get_name()
  return self._name
end


function VocabularyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VocabularyEntity.new(self._client, opts)
end
...
function VocabularyEntity:mark_deleted()
  self._deleted = true
end


function VocabularyEntity:deleted()
  return true == self._deleted
end


function VocabularyEntity:data_set(args)
  if args ~= nil then
...
function VocabularyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VocabularyEntity:match_set(args)
  if args ~= nil then
...
function VocabularyEntity:match_get()
...
function VocabularyEntity:stream(action, args, callopts)
...
function VocabularyEntity:_run_op(ctx, post_done)
  local utility = self._utility
