...
## Install
```bash
go get github.com/voxgig-sdk/gbif-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/gbif-sdk=../path/to/github.com/voxgig-sdk/gbif-sdk
```
...
```
github.com/voxgig-sdk/gbif-sdk/
...
The root package (`github.com/voxgig-sdk/gbif-sdk`) re-exports everything needed
