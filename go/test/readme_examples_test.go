...
const testSeed = `map[string]any{"entity": map[string]any{"enumeration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "literature": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "occurrence": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "registry": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "species": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vocabulary": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
