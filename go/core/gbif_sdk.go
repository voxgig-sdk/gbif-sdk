...
func (sdk *GbifSDK) OptionsMap() map[string]any {
...
func (sdk *GbifSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GbifSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GbifSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GbifSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GbifSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GbifSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GbifSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GbifSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GbifSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GbifSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
