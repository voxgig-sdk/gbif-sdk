...
func NewLiteratureEntity(client *core.GbifSDK, entopts map[string]any) *LiteratureEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LiteratureEntity) GetName() string { return e.name }
...
func (e *LiteratureEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LiteratureEntity) Deleted() bool {
	return e.deleted
}


func (e *LiteratureEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLiteratureEntity(e.client, opts)
}

func (e *LiteratureEntity) Data(args ...any) any {
...
func (e *LiteratureEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Literature; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LiteratureEntity) DataTyped(data ...Literature) Literature {
	if len(data) > 0 {
		return typedFrom[Literature](e.Data(asMap(data[0])))
	}
	return typedFrom[Literature](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Literature (all fields
// optional at the wire level).
func (e *LiteratureEntity) MatchTyped(match ...Literature) Literature {
	if len(match) > 0 {
		return typedFrom[Literature](e.Match(asMap(match[0])))
	}
	return typedFrom[Literature](e.Match())
}
...
func (e *LiteratureEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LiteratureEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LiteratureEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LiteratureListMatch and returns []Literature. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LiteratureEntity) ListTyped(reqmatch LiteratureListMatch, ctrl map[string]any) ([]Literature, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Literature](res), nil
}



func (e *LiteratureEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LiteratureEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LiteratureEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LiteratureEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
