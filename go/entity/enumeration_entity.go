...
func NewEnumerationEntity(client *core.GbifSDK, entopts map[string]any) *EnumerationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnumerationEntity) GetName() string { return e.name }
...
func (e *EnumerationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnumerationEntity) Deleted() bool {
	return e.deleted
}


func (e *EnumerationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnumerationEntity(e.client, opts)
}

func (e *EnumerationEntity) Data(args ...any) any {
...
func (e *EnumerationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Enumeration; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnumerationEntity) DataTyped(data ...Enumeration) Enumeration {
	if len(data) > 0 {
		return typedFrom[Enumeration](e.Data(asMap(data[0])))
	}
	return typedFrom[Enumeration](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Enumeration (all fields
// optional at the wire level).
func (e *EnumerationEntity) MatchTyped(match ...Enumeration) Enumeration {
	if len(match) > 0 {
		return typedFrom[Enumeration](e.Match(asMap(match[0])))
	}
	return typedFrom[Enumeration](e.Match())
}
...
func (e *EnumerationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnumerationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnumerationLoadMatch and returns an Enumeration. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EnumerationEntity) LoadTyped(reqmatch EnumerationLoadMatch, ctrl map[string]any) (Enumeration, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Enumeration{}, err
	}
	return typedFrom[Enumeration](res), nil
}




func (e *EnumerationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EnumerationListMatch and returns []Enumeration. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EnumerationEntity) ListTyped(reqmatch EnumerationListMatch, ctrl map[string]any) ([]Enumeration, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Enumeration](res), nil
}



func (e *EnumerationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EnumerationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EnumerationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnumerationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
