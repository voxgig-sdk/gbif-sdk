...
func NewVocabularyEntity(client *core.GbifSDK, entopts map[string]any) *VocabularyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VocabularyEntity) GetName() string { return e.name }
...
func (e *VocabularyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VocabularyEntity) Deleted() bool {
	return e.deleted
}


func (e *VocabularyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVocabularyEntity(e.client, opts)
}

func (e *VocabularyEntity) Data(args ...any) any {
...
func (e *VocabularyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Vocabulary; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VocabularyEntity) DataTyped(data ...Vocabulary) Vocabulary {
	if len(data) > 0 {
		return typedFrom[Vocabulary](e.Data(asMap(data[0])))
	}
	return typedFrom[Vocabulary](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Vocabulary (all fields
// optional at the wire level).
func (e *VocabularyEntity) MatchTyped(match ...Vocabulary) Vocabulary {
	if len(match) > 0 {
		return typedFrom[Vocabulary](e.Match(asMap(match[0])))
	}
	return typedFrom[Vocabulary](e.Match())
}
...
func (e *VocabularyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VocabularyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *VocabularyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VocabularyListMatch and returns []Vocabulary. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VocabularyEntity) ListTyped(reqmatch VocabularyListMatch, ctrl map[string]any) ([]Vocabulary, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Vocabulary](res), nil
}



func (e *VocabularyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VocabularyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VocabularyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VocabularyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
