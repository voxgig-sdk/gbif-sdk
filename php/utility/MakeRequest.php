...
// Gbif SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GbifMakeRequest
{
    public static function call(GbifContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GbifResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GbifResponse($fetched);
        } else {
