...
// Gbif SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GbifSDK::test)
...
{
    private const SDK_CLASS = 'GbifSDK';
    ...
    private const SDK_BASE = 'gbif_sdk';
