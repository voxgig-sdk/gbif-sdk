...
class GbifTestRunner
{
    ...
    {
        $live = self::getenv('GBIF_TEST_LIVE');
        $override = self::getenv('GBIF_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GBIF_TEST_EXPLAIN');
...
class_alias('GbifTestRunner', 'Runner');
class_alias('GbifHelpers', 'Helpers');
