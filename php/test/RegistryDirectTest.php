...
class RegistryDirectTest extends TestCase
{
    public function test_direct_list_registry(): void
    {
        $setup = registry_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-registry", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
