...
class GbifStreamingFeature extends GbifBaseFeature
{
    ...
    private function _iterate(GbifResult $result): \Generator
    {
    ...
    private function _streamable(GbifContext $ctx): bool
    {
