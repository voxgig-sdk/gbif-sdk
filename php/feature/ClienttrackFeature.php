...
class GbifClienttrackFeature extends GbifBaseFeature
{
    ...
    public function PostConstruct(GbifContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Gbif-SDK';
