...
class GbifRatelimitFeature extends GbifBaseFeature
{
    ...
    private function _acquire(GbifContext $ctx): void
    {
    ...
    private function _track(GbifContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
