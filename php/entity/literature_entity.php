...
class LiteratureEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LiteratureEntity($this->_client, $opts);
    }

    /**
     * @param Literature|array $args Literature data (assoc-array) to store.
     */
    ...
    /**
     * @return Literature|array The current Literature data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Literature fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Literature fields).
     */
    ...
    /**
     * List Literature items matching the given filter.
     *
     * @param LiteratureListMatch|array|null $reqmatch Match filter (any subset
     *   of Literature fields) as an assoc-array; LiteratureListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Literature[]|array A list of Literature items as assoc-arrays at
