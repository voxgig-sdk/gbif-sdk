...
class VocabularyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VocabularyEntity($this->_client, $opts);
    }

    /**
     * @param Vocabulary|array $args Vocabulary data (assoc-array) to store.
     */
    ...
    /**
     * @return Vocabulary|array The current Vocabulary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Vocabulary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Vocabulary fields).
     */
    ...
    /**
     * List Vocabulary items matching the given filter.
     *
     * @param VocabularyListMatch|array|null $reqmatch Match filter (any subset
     *   of Vocabulary fields) as an assoc-array; VocabularyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Vocabulary[]|array A list of Vocabulary items as assoc-arrays at
