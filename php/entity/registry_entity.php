...
class RegistryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RegistryEntity($this->_client, $opts);
    }

    /**
     * @param Registry|array $args Registry data (assoc-array) to store.
     */
    ...
    /**
     * @return Registry|array The current Registry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Registry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Registry fields).
     */
     ...
     *
     * @param RegistryListMatch|array|null $reqmatch Match filter (any subset
     *   of Registry fields) as an assoc-array; RegistryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Registry[]|array A list of Registry items as assoc-arrays at
