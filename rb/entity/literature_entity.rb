...
class LiteratureEntity
  ...
  def make
    opts = @_entopts.dup
    LiteratureEntity.new(@_client, opts)
  end
  ...
  # @return [Literature, Hash] the current Literature data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Literature fields)
  def match_get
  ...
  #
  # @param reqmatch [LiteratureListMatch, Hash, nil] match filter (any subset of
  #   Literature fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Literature>, Array] the matching Literature items; raises GbifError on failure
