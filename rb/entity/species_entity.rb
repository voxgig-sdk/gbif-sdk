...
class SpeciesEntity
  ...
  # @return [Species, Hash] the loaded Species; raises GbifError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Species>, Array] the matching Species items; raises GbifError on failure
