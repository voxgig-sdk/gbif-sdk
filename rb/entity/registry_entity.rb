...
class RegistryEntity
  ...
  def make
    opts = @_entopts.dup
    RegistryEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [RegistryListMatch, Hash, nil] match filter (any subset of
  #   Registry fields); defaults to nil, treated as an empty match that lists all.
