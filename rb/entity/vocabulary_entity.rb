...
class VocabularyEntity
  ...
  def make
    opts = @_entopts.dup
    VocabularyEntity.new(@_client, opts)
  end
  ...
  # @return [Vocabulary, Hash] the current Vocabulary data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Vocabulary fields)
  def match_get
  ...
  #
  # @param reqmatch [VocabularyListMatch, Hash, nil] match filter (any subset of
  #   Vocabulary fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Vocabulary>, Array] the matching Vocabulary items; raises GbifError on failure
