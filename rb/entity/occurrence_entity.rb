...
class OccurrenceEntity
  ...
  def make
    opts = @_entopts.dup
    OccurrenceEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [OccurrenceListMatch, Hash, nil] match filter (any subset of
  #   Occurrence fields); defaults to nil, treated as an empty match that lists all.
