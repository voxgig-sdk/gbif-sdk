...
module GbifTestRunner
  ...
  def self.env_override(m)
    live = getenv("GBIF_TEST_LIVE")
    override = getenv("GBIF_TEST_OVERRIDE")
    ...
    explain = getenv("GBIF_TEST_EXPLAIN")
    m["GBIF_TEST_EXPLAIN"] = explain if explain && !explain.empty?
