...
```ruby
results, err = client.Enumeration.list(nil)
```
...
```ruby
results, err = client.Literature.list(nil)
```
...
```ruby
results, err = client.Occurrence.list(nil)
```
...
```ruby
results, err = client.Registry.list(nil)
```
...
```ruby
results, err = client.Vocabulary.list(nil)
```
