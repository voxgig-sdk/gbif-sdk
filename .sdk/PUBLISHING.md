...
|---|---|---|
| `ts/` | @voxgig-sdk/gbif-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/gbif-sdk \
      --repository voxgig-sdk/gbif-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/gbif-sdk` shows it, and
`npm trust revoke @voxgig-sdk/gbif-sdk --id=<id>` removes it.
