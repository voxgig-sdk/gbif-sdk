...
class GbifCacheFeature extends GbifBaseFeature
{
    ...
    private function _through(GbifContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
