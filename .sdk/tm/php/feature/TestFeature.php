...
// Gbif SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GbifTestFeature extends GbifBaseFeature
{
    ...
    public function init(GbifContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GbifContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GbifContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GbifContext $ctx, $op, $args): array
    {
