...
class GbifProxyFeature extends GbifBaseFeature
{
    ...
    public function init(GbifContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GbifContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
