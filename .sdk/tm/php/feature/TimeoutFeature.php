...
class GbifTimeoutFeature extends GbifBaseFeature
{
    ...
    private function _with_timeout(GbifContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GbifContext $_ctx, float $ms): void
    {
        $client = $this->client;
