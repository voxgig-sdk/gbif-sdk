...
class GbifRbacFeature extends GbifBaseFeature
{
    ...
    private function _required(GbifContext $ctx): ?string
    {
    ...
    private function _reject(GbifContext $ctx, string $required): void
    {
    ...
    private function _track(GbifContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
