...
class GbifFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GbifSDK/1.0)';
    ...
    public static function call(GbifContext $ctx, string $fullurl, array $fetchdef): array
    {
