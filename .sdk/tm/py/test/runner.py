...
class GbifTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GbifTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GbifTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GbifTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
