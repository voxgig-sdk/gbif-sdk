...
class GbifTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GbifTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GbifTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GbifTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
