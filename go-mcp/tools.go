...
type Args struct {
	Entity string         `json:"entity" jsonschema:"enumeration | literature | occurrence | registry | species | vocabulary"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GbifSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "gbif_list",
		Description: "List records from Gbif. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "gbif_load",
		Description: "Load a single record from Gbif. " +
...
func runOp(client *sdk.GbifSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GbifSDK, name string) (sdk.GbifEntity, error) {
	switch strings.ToLower(name) {
	case "enumeration":
		return client.Enumeration(nil), nil
	case "literature":
		return client.Literature(nil), nil
	case "occurrence":
		return client.Occurrence(nil), nil
	case "registry":
		return client.Registry(nil), nil
	case "species":
		return client.Species(nil), nil
	case "vocabulary":
		return client.Vocabulary(nil), nil
