...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/gbif` | `npm install @voxgig-sdk/gbif` |
| Python | `voxgig-sdk-gbif` | `pip install voxgig-sdk-gbif` |
| PHP | `voxgig-sdk/gbif` | `composer require voxgig-sdk/gbif` |
| Golang | `github.com/voxgig-sdk/gbif-sdk/go` | `go get github.com/voxgig-sdk/gbif-sdk/go` |
| Ruby | `voxgig-sdk-gbif` | `gem install voxgig-sdk-gbif` |
| Lua | `voxgig-sdk-gbif` | `luarocks install voxgig-sdk-gbif` |
