# Gbif SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GbifSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GbifSDK(...) and GbifSDK.test(...) become
#      GbifSDK.test({"entity": {...}}) seeding one mock record (id "test01")
