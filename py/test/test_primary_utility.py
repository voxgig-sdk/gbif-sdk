...
from gbif_sdk.core.spec import GbifSpec
from gbif_sdk.core.result import GbifResult
from gbif_sdk.core.response import GbifResponse
from gbif_sdk.core.operation import GbifOperation
from gbif_sdk.core.error import GbifError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = GbifSDK.test(None, None)
        ...
        class TestInitFeature(GbifBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GbifBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GbifSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GbifSDK.test(None, setup_opts)
