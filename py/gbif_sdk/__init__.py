...
from gbif_sdk.utility import register

# Load features
from gbif_sdk.feature.base_feature import GbifBaseFeature
from gbif_sdk.features import _has_feature, _make_feature
...
class GbifSDK:
    ...
    def get_utility(self):
        return GbifUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "GbifSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GbifSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Enumeration(self, data=None) -> "EnumerationEntity":
        ...
        from gbif_sdk.entity.enumeration_entity import EnumerationEntity
    ...
    def Literature(self, data=None) -> "LiteratureEntity":
        ...
        from gbif_sdk.entity.literature_entity import LiteratureEntity
    ...
    def Occurrence(self, data=None) -> "OccurrenceEntity":
        ...
        from gbif_sdk.entity.occurrence_entity import OccurrenceEntity
    ...
    def Registry(self, data=None) -> "RegistryEntity":
        ...
        from gbif_sdk.entity.registry_entity import RegistryEntity
    ...
    def Species(self, data=None) -> "SpeciesEntity":
        ...
        from gbif_sdk.entity.species_entity import SpeciesEntity
    ...
    def Vocabulary(self, data=None) -> "VocabularyEntity":
        ...
        from gbif_sdk.entity.vocabulary_entity import VocabularyEntity
