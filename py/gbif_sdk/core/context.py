...
from gbif_sdk.core.control import GbifControl
...
from gbif_sdk.core.helpers import get_ctx_prop, to_map
...
class GbifContext:
    ...
    def make_error(self, code, msg):
        return GbifError(code, msg, self)
